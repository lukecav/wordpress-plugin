                    ...
                    <tr valign="top">
                        ...
                        <td>
                            <select name="mailgun[override-from]">
                                <option value="1"<?php selected('1', $this->get_option('override-from')); ?>><?php _e('Yes', 'mailgun'); ?></option>
                                <option value="0"<?php selected('0', $this->get_option('override-from')); ?>><?php _e('No', 'mailgun'); ?></option>
                            </select>
